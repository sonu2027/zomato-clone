...
function Restaurant({ status, img, shopName, aboutShop, rating, price, time, title, calling, distance, address, inputvalue, bookmarkcontent = false, restaurant }) {
                ...
                <div className="restaurant-image">
                    {
                        apply == false || bookmarkcontent == true ?
                            ...
                            restaurant.map((e, i) => <RestaurantList
                                key={e._id}
                                id={e._id}
