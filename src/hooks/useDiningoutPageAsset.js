...
function useDiningoutPageAsset() {
  const img = [
    img0,
    img1,
    img2,
  ...
  const aboutShop = [
    ...
    "Healthy Food, Sandwich, Fast Food, Wraps, Salad, Beverage",
    "Bengali, Street Food, Rolls, Kebab, Fast Foo",
    "Beverages, Te",
  ...
  const rating = [
    3.5, 4, 3, 4.5, 3, 3.5, 4.5, 4, 4, 3.5, 4.5, 4.5, 4.5, 2.5, 3, 4, 3.5, 4,
    3.5, 4, 3, 4.5, 3, 3.5, 4.5, 4,
  ];

  const price = [
    50, 200, 185, 45, 99, 120, 259, 100, 78, 225, 65, 199, 155, 100, 150, 60,
    200, 125, 50, 200, 185, 45, 99, 120, 259, 100,
  ];

  const distance = [
    5.4, 4, 3.3, 1.2, 6.5, 3.8, 1.5, 1.8, 9, 2.6, 2.2, 1.9, 1.5, 1.2, 2, 3.6,
    2.4, 3.2, 2.5, 4, 3.5, 9.9, 6.5, 3.8, 1.5, 1.8,
  ];
  const address = [
    "Behela, kolkata",
    "Alipore, kolkata",
...
export default useDiningoutPageAsset;
