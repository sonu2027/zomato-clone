...
function NightLife() {
    ...
    const rating = [4.1, 4.4, 4.2, 4.5, 3, 3.5, 4.5, 4, 4, 3.5, 4.5, 4.5, 4.5, 2.5, 3, 4, 3.5, 4, 3.5, 4, 3, 4.5, 3, 3.5, 4.5, 4, 4.1, 4.4, 4.2, 4.5, 3, 3.5, 4.5, 4, 4, 3.5, 4.5, 4.5, 3.9]

    const price = [1400, 1200, 1850, 450, 990, 1200, 2599, 1090, 778, 2250, 645, 1099, 1505, 1000, 1500, 690, 2080, 1250, 5900, 2000, 1985, 450, 990, 1200, 2590, 1100, 1400, 1200, 1850, 450, 990, 1200, 2599, 1090, 778, 2250, 645, 1099, 1505]

    const distance = [3.3, 1.2, 3.3, 1.2, 6.5, 3.8, 1.5, 1.8, 9, 2.6, 2.2, 1.9, 1.5, 1.2, 2, 3.6, 2.4, 3.2, 2.5, 4, 3.5, 4.9, 6.5, 3.8, 1.5, 1.8, 3.3, 1.2, 3.3, 1.2, 6.5, 3.8, 1.5, 1.8, 9, 2.6, 2.2, 1.9, 1.5]
    const address = ["Enclave, Alipore, Kolkata", "Alipore, kolkata", "New Alipore, kolkata", "Encalve, Alipore, kolkata", "Taratala, kolkata", "Behela, kolkata", "Encalve, Alipore, kolkata", "Taratala, kolkata", "Encalve, Alipore, kolkata", "Alipore, kolkata", "Behela, kolkata", "Alipore, kolkata", "Taratala, kolkata", "New Alipore, kolkata", "Encalve, Alipore, kolkata", "Taratala, kolkata", "Behela, kolkata", "New Alipore, kolkata", "Behela, kolkata", "Encalve, Alipore, kolkata", "Alipore, kolkata", "New Alipore, kolkata", "Encalve, Alipore, kolkata", "Encalve, Alipore, kolkata", "Encalve, Alipore, kolkata", "Alipore, kolkata", "Enclave, Alipore, Kolkata", "Alipore, kolkata", "New Alipore, kolkata", "Encalve, Alipore, kolkata", "Taratala, kolkata", "Behela, kolkata", "Encalve, Alipore, kolkata", "Taratala, kolkata", "Encalve, Alipore, kolkata", "Alipore, kolkata", "Behela, kolkata", "Alipore, kolkata", "Taratala, kolkata", "Taratala, kolkata"]
